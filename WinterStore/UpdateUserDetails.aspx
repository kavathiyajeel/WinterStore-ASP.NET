<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateUserDetails.aspx.cs" Inherits="WinterStore.UpdateUserDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container-fluid mt-2 mb-2 rounded-4" style="margin:auto  ; width: 70%; border: 2px solid black">
            <table class="table" style="color:black">
                ...
                <tr class="row">
                    <td class="col">
                        <h3 class="text-center"><i class="bi bi-pencil-square mr-2"></i>Update User</h3>
                    </td>
                </tr>
                <%--FULLNAME--%>
                <tr class="row">
                    ...
                    <td class="col-md-4" style="text-align: center">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter a FirstName" ControlToValidate="txt_fname" ForeColor="Red" SetFocusOnError="True" Display="Dynamic"></asp:RequiredFieldValidator>
                ...
                <%--## Button ##--%>
                    ...
                    <td class="col-md-12" style="text-align: center">
                        <asp:Button ID="Button1" CssClass="btn btn-outline-warning" Width="30%" runat="server" Text="Update User" OnClick="Button1_Click"/>
                    </td>
